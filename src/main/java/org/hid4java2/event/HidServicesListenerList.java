...
import org.hid4java2.HidServicesListener;
...
public class HidServicesListenerList {
   ...
   */
  public void fireHidDeviceAttached(final HidDevice device) {
    ...
    executorService.submit(
      new Runnable() {
        ...
        public void run() {
          ...
          HidServicesEvent event = new HidServicesEvent(device);
   ...
   *
   * @param device The device that was detached
   */
  public void fireHidDeviceDetached(final HidDevice device) {
   ...
   *
   * @param device The device info that caused the error if known
   */
  public void fireHidFailure(final HidDevice device) {
